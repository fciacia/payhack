...
class _DashboardPageState extends State<DashboardPage> {
  ...
  Widget build(BuildContext context) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (!_travelerPopupShown) {
        setState(() => _travelerPopupShown = true);
        showDialog(
          context: context,
          builder: (context) => AlertDialog(
            title: const Text('Welcome to Thailand 🇹🇭'),
            content: Column(
              mainAxisSize: MainAxisSize.min,
              crossAxisAlignment: CrossAxisAlignment.start,
              children: const [
                Text('Explore sustainable local businesses nearby!'),
                SizedBox(height: 8),
                Text(
                  'Choose greener transport options with [Local Transit App Integration].',
                ),
                SizedBox(height: 8),
                Text(
                  '💡 FX tip: Try "Green FX" or use your green stablecoin for THB spending.',
                ),
              ],
            ),
            actions: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  // Pie chart breakdown (simple custom painter for demo)
                  SizedBox(
                    height: 60,
                    width: 60,
                    child: CustomPaint(
